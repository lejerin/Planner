...
public class TimerView extends View {
    ...
    private static final float THICKNESS_SCALE = 0.05f;
    ...
    private Paint mCircleGrayPaint;
    ...
    public TimerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mCircleGrayPaint = new Paint();
        mCircleGrayPaint.setAntiAlias(true);
        mCircleGrayPaint.setColor(Color.GRAY);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mCircleSweepAngle > 0f) {
            mCanvas.drawArc(mCircleOuterBounds, ARC_START_ANGLE, -360 + mCircleSweepAngle , true, mCircleGrayPaint);
